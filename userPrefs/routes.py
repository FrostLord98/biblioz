...
from userPrefs.models import UserFavoriteGenre
from userPrefs.schemas import UserFavoriteGenreSchema
from userPrefs.swagger_models import api , user_preferences_model
from book.swagger_models import get_book
